							...
							<header className="flex w-full flex-col gap-2 rounded-md bg-gradient-to-b from-black to-neutral-800 px-10 pb-2 md:w-11/12">
										...
										{sessionData?.user.admin && (
											<>
												<div className="group relative">
													...
													<div className="absolute -left-7 w-20 rounded-md border border-zinc-700 bg-black px-2 py-1 text-center text-xs opacity-0 group-hover:opacity-100">
														{projectData.approved ? 'Unapprove' : 'Approve'}
													</div>
												</div>
												<div className="group relative">
								...
								<div className="flex items-end justify-between">
									...
									<h3 className=" ml-2 text-right text-xl">
										for <span className="font-bold"> {projectData.client}</span>
									</h3>
								</div>
								...
								{projectData.notes && (
									<NeutralCard className="w-72">
										<div className="flex flex-col justify-between">
											...
											<p className="whitespace-pre-wrap">{projectData.notes}</p>
										</div>
									</NeutralCard>
								)}
							</div>
